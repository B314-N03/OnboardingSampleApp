...
function DataMapping({ onboardingData }) {
  ...
  const suggest = async () => {
    ...
    setMessage(null);
    try {
      const res = await apiFetch(`/api/customers/${customerId}/mapping/suggest`, {
        method: 'POST',
  ...
  const confirm = async () => {
    ...
    try {
      ...
      const res = await apiFetch(`/api/customers/${customerId}/mapping`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
      ...
      const stepRes = await apiFetch(`/api/customers/${customerId}/steps/step_2`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
